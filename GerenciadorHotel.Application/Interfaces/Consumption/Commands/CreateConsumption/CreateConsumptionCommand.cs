...
namespace GerenciadorHotel.Application.Interfaces.Consumption.Commands.CreateConsumption
{
    ...
    {
        public CreateConsumptionCommand(int idProduct, int idReservation, int quantity, DateTime date, string? observation)
        {
            IdProduct = idProduct;
        ...
        => new(IdProduct, IdReservation, Quantity, value, Date);
    }
}